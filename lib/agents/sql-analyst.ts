...
1. Читай инструкции через \`read_instruction\` когда тебе нужна подробная информация по теме.
2. Можно вызвать несколько инструментов одновременно если нужны данные из разных справочников.
